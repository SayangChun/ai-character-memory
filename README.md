...
```
  各网页 AI 对话（ChatGPT / Claude / 国产模型 …）
           │
           ▼
  本站整理：角色人设 + 记忆库（可从对话文本提取）
           │
           ▼
...
|--------------|------|
| 记忆散落在各网页产品里 | 统一进本地文件 |
| 换 AI 要重讲一遍设定 | 把 `.memory.md` 发给新 AI |
| 恢复依赖中转站 / 插件 | **文件即记忆源**，直连新 AI |

本站是 **整理器与导出器**，不是新 AI 恢复记忆时的必经中转站。
